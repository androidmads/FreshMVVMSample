...
namespace FreshMvvm
{
    public static class PopupExtension
    {
        ...
        public static async Task PopPopupPageModelTask(this IPageModelCoreMethods pageModelCoreMethods, bool animate = true)
        {
            await PopupNavigation.Instance.PopAsync(animate);
        }

        public static async void PopPopupPageModel(this IPageModelCoreMethods pageModelCoreMethods, bool animate = true)
        {
            await PopupNavigation.Instance.PopAsync(animate);
        }
